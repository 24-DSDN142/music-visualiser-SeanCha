...
function draw_one_frame(words, vocal, drum, bass, other,counter) {
  ...
  let circleX = noiseLevel * noise(nt) +400
  let circleY = noiseLevel * noise(nt+10000) +600

  let vocalRange = map(vocal, 0, 100, 0, 20)
  for (let i = 0; i < 20; i++){
    glow(color(255), 400)
    rect(circleX,circleY-i*55-25,30+i*3+vocalRange,50)
  }
  stroke(0)
  ellipse(circleX,circleY,45+vocalRange)
